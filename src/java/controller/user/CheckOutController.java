...
public class CheckOutController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Order o = od.getOrderNewById(user_id);
        ...
        //Order onew = od.getOrderNewById(user_id);
        ...
        try {
            ...
            String to = email;
            String from = "nghiadmhe171283@fpt.edu.vn";
            ...
            String body
                    ...
                    + "                                                    <a href=\"http://localhost:9999/Baby_Shop_Online/home\"\n"
                    + "                                                       style=\"font-size:30px;text-decoration:none;color:#333\"\n"
                    + "                                                       target=\"_blank\"\n"
                    + "                                                       data-saferedirecturl=\"https://www.google.com/url?q=https://thevapeclub.vn&amp;source=gmail&amp;ust=1655483413010000&amp;usg=AOvVaw3mqQmYH-B0jekACwJJY5LC\">BabyShop</a>\n"
                    + "                                                </h1>\n"
                    + "\n"
                    + "                                            </td>\n"
                    + "                                            <td\n"
                    ...
                    + "</body>\n"
                    + "</html>";
            String password = "lftk osbg tdka gppe";
        ...
        request.getRequestDispatcher("view/user/payment/cartCompletion.jsp").forward(request, response);
    }
