...
<style>
    ...
    .notification {
        position: relative;
        padding-right: 40px; /* Ensure there's enough space for the close button */
    }

    .notification .close {
        position: absolute;
        top: 50%;
        right: 10px; /* Move the button away from the edge */
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu1.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu2.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu3.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu4.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu5.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu6.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu7.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu8.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu9.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu10.png"><br>
                <img style="max-width: 100%; padding-bottom: 2%;" src="img/cart-completion/htu11.png"><br>
                <img style="max-width: 100%;" src="img/cart-completion/htu12.png">
            </div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Hướng dẫn thanh toán bằng video</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="row" style="margin-top: 9%;">
        <div class="col-md-6 border-right">
            <div class="p-3 py-5 text-center">
                <img style="width: 40%;" src="img/cart-completion/checked.png">
                ...
                <button type="button" class="btn btn-dark mt-3" data-toggle="modal" data-target="#exampleModalLong">Hướng dẫn thanh toán</button>
                <button type="button" class="btn btn-outline-dark mt-3" data-toggle="modal" data-target="#exampleModalCenter">Hướng dẫn thanh toán bằng video</button>
            </div>
        </div>
        <div class="col-md-6">
            <div class="p-3 py-5">
                ...
                <form action="checkout" method="POST">
                    <label class="payment-method__item">
                        ...
                        <span class="payment-method__item-icon-wrapper"><img src="img/cart-completion/cod.png"></span>
                    ...
                    <label class="payment-method__item">
                        ...
                        <span class="payment-method__item-icon-wrapper"><img src="img/cart-completion/vnpay.png"></span>
                        <span class="payment-method__item-name">Thẻ ATM / Internet Banking<br>Thẻ tín dụng (Credit card) / Thẻ ghi nợ (Debit card)<br>VNPay QR</span>
                    </label>
                    <input type="hidden" name="order_id" value="${order_id}"/>
                    <input type="hidden" name="total_cost" value="${total_cost}"/>
                    <div class="mt-5 text-center"><button class="btn btn-primary" type="submit">Thanh toán</button></div>
                </form>
            </div>
        </div>
    </div>
