...
<html lang="en">
    <head>
        ...
        <title>G6 - Quản Lý | Sửa Bài viết</title>
        ...
        <div class="container body">
            <div class="main_container">
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Quản lý trang tin tức<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="listblogadmin">Danh sách bài viết</a></li>
                                            <li><a href="addBlog.jsp">Thêm bài viết</a></li>
                                        </ul>
                                    </li>
                ...
                <div class="container-sm">
                    <div class="card">
                        <div class="card-header" style="background:#c1c5c9">
                            <h2 class="text-center" style="font-size: 35px; color: #24292e">Sửa bài viết</h2>
                        </div>
                        <div class="card-body">
                        ...
                        <form action="updateblog" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="blogId" name="blogId" value="${b.blogId}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="title" class="form-label">Tiêu đề</label>
                                <input type="text" class="form-control" id="title" name="title" value="${b.title}" required>
                            </div>
                            <div class="mb-3">
                                <label for="heading" class="form-label">Nội dung ngắn</label>
                                <input type="text" class="form-control" id="heading" name="heading" value="${b.heading}" required>
                            </div>
                                  <div class="mb-3" >
                                <label class="control-label">Nội dung bài viết</label>
                                <div id="editor" style="height: 300px ;color: black">${b.description}</div>
                                <input type="hidden" id="description" name="description" >
                            </div>
                            
                            <div class="mb-3">
                                <label for="image" class="form-label">Hình ảnh</label>
                                <img width="180px" id="previewImage" src="img2/${b.image}" />
