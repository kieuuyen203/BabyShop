<%-- 
    Document   : list-order-cancel
    Created on : Jul 6, 2024, 2:24:43 AM
    Author     : FPT
--%>
...
<html lang="en">
    <head>
        ...
        <title>G6- Quản lý|Danh sách đơn hàng đã hủy </title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Đơn Hàng: <small>Danh sách đơn hàng đã hủy</small></h3>
                            </div>
                                        ...
                                        <table class="table table-striped projects">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-success btn-xs">Đã Hủy</button>
                                                    </td>
                                                    <td>
