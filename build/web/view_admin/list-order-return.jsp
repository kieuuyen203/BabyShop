<%-- 
    Document   : list-order-return
    Created on : Jul 6, 2024, 2:26:17 AM
    Author     : FPT
--%>
...
<html lang="en">
    <head>
        ...
        <title>G6- Quản lý|Danh sách đơn hàng đã hoàn trả </title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Đơn Hàng: <small>Danh sách đơn hàng yêu cầu hoàn trả</small></h3>
                            </div>
                                        ...
                                        <table class="table table-striped projects">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-success btn-xs">Yêu cầu hoàn trả</button>
                                                    </td>
                                                    <td>
