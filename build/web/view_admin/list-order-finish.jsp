<%-- 
    Document   : list-order-finish
    Created on : Jul 6, 2024, 2:26:32 AM
    Author     : FPT
--%>
...
<html lang="en">
    <head>
        ...
        <title>G6- Quản lý|Danh sách đơn hàng đã giao thành công </title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Đơn Hàng: <small>Danh sách đơn hàng đã giao thành công</small></h3>
                            </div>
                                        ...
                                        <table class="table table-striped projects">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-success btn-xs">Thành Công</button>
                                                    </td>
                                                    <td>
