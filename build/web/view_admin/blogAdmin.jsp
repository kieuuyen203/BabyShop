...
<html lang="en">
    <head>
        ...
        <title>G6 - Quản Lý | Danh sách bài viết</title>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item active">
                                    <a class="nav-link" href="addblog"><i class="fas fa-plus-circle"></i> Thêm Bài viết mới</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                                        ...
                                        <ul class="pagination" >
                                            ...
                                            <c:forEach begin="1" end="${end}" var="i">
                                                <li class="page-item"style="text-align: center">
                                                    <a class="page-link" href="listblogadmin?index=${i}&service=${ser != null ? ser : 'Checkagain'}&searchblog=${textSearch}">
                                                        ${i}
                                                    </a>
                                                </li>
                                            </c:forEach>
