<%-- 
    ...
    Created on : Jul 5, 2024, 7:13:41 PM
    Author     : FPT
--%>
...
<html lang="en">
    <head>
        ...
        <title>G6 - Quản lý | Thông tin người dùng </title>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Mã Tài Khoản <small>ghi số ID người dùng</small></h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Họ Và Tên <span class="required">*</span>
                                                </label>
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align">Ngày Tháng Năm Sinh <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
