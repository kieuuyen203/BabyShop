...
function assign(ta, {setOverflowX = true, setOverflowY = true} = {}) {
    ...
    const destroy = function (style) {
        ...
        this.removeEventListener('input', update, false);
        this.removeEventListener('keyup', update, false);
        this.removeEventListener('autosize:destroy', destroy, false);
        this.removeEventListener('autosize:update', update, false);

        // Remove textarea from the set (assuming `set` is defined elsewhere)
        set.delete(this);
